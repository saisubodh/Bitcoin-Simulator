...
typedef struct {
  ...
  long    CmpctReceivedBytes;
  long     BlockTxnReceivedBytes;
  long     GetBlockTxnReceivedBytes;
  long     MsgCmpctBlockReceivedBytes;
  long     SendCmpctReceivedBytes;
  long     CmpctSentBytes;
  long     BlockTxnSentBytes;
  long     GetBlockTxnSentBytes;
  long     MsgCmpctBlockSentBytes;
  long     SendCmpctSentBytes;
  long     CmpctBlockNotProcessed;
  long     NumGBTSentInCmpct;
  long     NumFullBlockInCmpct;
} nodeStatistics;
